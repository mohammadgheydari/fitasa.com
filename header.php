        ...
        <nav class="white hide-on-med-and-down my-nav">
            ...
            <div class="nav-wrapper">
                <ul class="right hide-on-med-and-down">
                    <li>
                        <a class="dropdown-button black-text waves-effect waves-purple" href="javascript:void(0)"
                    ...
                    <li>
                        <a class="dropdown-button black-text waves-effect waves-purple" href="javascript:void(0)" data-activates="dropdown4"
                           data-constrainwidth="false" data-alignment="right" data-hover="true">
