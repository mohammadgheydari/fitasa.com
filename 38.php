...
<div class="container">
    <div class="row margin-bottom-0">
        ...
        <div class="col s12 m12 l12">
            <h5 class="breadcrumbs-title "><i class="mdi-action-track-changes"></i>پروفایل باشگاه</h5>
    ...
    <div class="row">
        <div class="col l9 m12 s12 right">
                    ...
                    <div class="col s12 m12 l10 offset-l1">
                        ...
                        <div class="col s12 m6 right">
                            <div class="input-field ">
                                ...
                                <input id="month" type="text" class="validate price">
                        ...
                        <div class="col s12 m6 right">
                            <div class="input-field ">
                                <i class="mdi-action-credit-card prefix"></i>
                                <input id="session" type="text" class="validate price">
