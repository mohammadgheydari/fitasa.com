...
<div class="container">
    <div class="row margin-bottom-0">
        ...
        <div class="col s12 m12 l12">
            <h5 class="breadcrumbs-title "><i class="mdi-action-account-balance-wallet"></i>گزارش مالی باشگاه</h5>
                    ...
                    <form action="#">
                        ...
                        <div class="col s12 m6 l4 right">
                            <div class="input-field">
                                ...
                                <input type="text" id="amount-from" class="validate price"/>
                            </div>
                        </div>
                        <div class="col s12 m6 l4 right">
                            <div class="input-field">
                                ...
                                <i class="mdi-editor-attach-money prefix"></i>
                                <input type="text" id="amount-to" class="validate price"/>
                            </div>
                        </div>
...
<!--                    </li>-->
            ...
            <div class="clear"></div>
            <table class="responsive-table striped centered farzan-table second-col-shrink first-col-shrink" id="pay-table">
