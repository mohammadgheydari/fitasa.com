...
<div class="container">
    <div class="row margin-bottom-0">
        ...
        <div class="col s12 m12 l12">
            <h5 class="breadcrumbs-title "><i class="mdi-social-people"></i>ثبت نام انبوه کاربر سازمان</h5>
...
<div class="row">
    <div class="col s12">
<p>
    در صورتیکه می خواهید از طریق اکسل، کاربران سازمان را اضافه کنید می توانید ساختار اکسل
    <a href="#">فایل نمونه اکسل</a>
    را به عنوان قالب استفاده نمایید
    </p>
    </div>
</div>
    <div class="row">
