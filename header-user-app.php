        ...
        <nav class="white hide-on-med-and-down my-nav">
            ...
            <div class="nav-wrapper">
                <ul class="right hide-on-med-and-down">
                    <li>
                        <a class="dropdown-button black-text waves-effect waves-purple" href="javascript:void(0)" data-activates="dropdown1"
                    ...
                    <li>
                        <a class="black-text waves-effect waves-purple" href="#">
                            <i class="mdi-action-assignment"></i>
                            <span>نقشه راه</span>
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-button black-text waves-effect waves-purple" href="javascript:void(0)" data-activates="dropdown2"
                           data-constrainwidth="false" data-alignment="right" data-hover="true">
                    ...
                    <li>
                        <a class="dropdown-button black-text waves-effect waves-purple" href="javascript:void(0)" data-activates="dropdown3"
                           data-constrainwidth="false" data-alignment="right" data-hover="true">
                            <i class="mdi-social-people"></i>
                            <span>مشاوره</span>
                        </a>
                    </li>
                    <li><a class="dropdown-button black-text waves-effect waves-purple" href="javascript:void(0)" data-activates="dropdown4"
                            data-constrainwidth="false" data-alignment="right" data-hover="true">
                                                        <i class="mdi-action-class"></i>
                                                        <span>آموزش</span>
                                                    </a>
                                                </li>
                                                <li><a class=" green darken-1 white-text waves-effect waves-purple" href="#">
                                                        <i class="mdi-content-archive"></i>
                                                        <span>دانلود اپ</span>
                                                    </a>
                                                </li>
                            <!--                    <li>-->
<!--                        <a class="dropdown-button black-text waves-effect waves-purple" href="javascript:void(0)" data-activates="dropdown5"-->
<!--                           data-constrainwidth="false" data-alignment="right" data-hover="true">-->
...
<nav class="hide-on-large-only mobile-nav">
    <div class="nav-wrapper white">
        <!--        ==================================button menu============================/-->
        <a href="#" data-activates="mobile-demo" class="button-collapse right btn btn-floating purple darken-1">
        ...
        <ul class="side-nav collapsible collapsible-accordion" id="mobile-demo">
            ...
            <!--            ===================items===========-->
            <li><a class="collapsible-header waves-effect waves-purple"><i class="mdi-action-dashboard right"></i>
                    مالی
                </a>
            ...
            <li><a class="collapsible-header waves-effect waves-purple"><i
            ...
            <li><a class="collapsible-header waves-effect waves-purple"><i
                        class="mdi-social-people right"></i> کاربران </a>

                <div class="collapsible-body">
                    <ul>
                        <li><a href="users-managment.php">مدیریت کاربران</a></li>
                        <li><a href="users-registration.php">کاربر جدید</a></li>
                    </ul>
                </div>
            </li>
            <li><a class="collapsible-header waves-effect waves-purple"><i
                        class="mdi-content-mail right"></i> پیام ها و هشدارها </a>
            </li>

            <li><a class="collapsible-header remove-arrow waves-effect waves-purple"><i
                        class="mdi-editor-insert-invitation right "></i> تقویم </a>
            </li>

            <li><a class="collapsible-header waves-effect waves-purple"><i class="mdi-action-settings right"></i> تنظیمات </a>
...
<!--            <li><a class="collapsible-header waves-effect waves-purple">-->
