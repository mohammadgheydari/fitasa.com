...
<div class="container">
    <div class="row margin-bottom-0">
        ...
        <div class="col s12 m12 l12">
            <h5 class="breadcrumbs-title "><i class="mdi-social-person"></i>ویرایش پروفایل کاربر</h5>
            ...
            <div class="col s12 right">
                <div class=" card z-depth-1 card-content white">
                    <form action="#">
                        ...
                        <div class="col s12 m6 l3 right">
                            <div class="input-field">
                                <label class="date-picker-lbl" for="date"> تاریخ تولد</label>
                                <i class="mdi-editor-insert-invitation prefix "></i>
                                <input type="text" id="date" class="validate pdate"/>
                            </div>
                        </div>
                        <div class="col s12 m6 l3 right">
                            <div class="input-field">
