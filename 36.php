...
<div class="container">
    <div class="row margin-bottom-0">
        ...
        <div class="col s12 m12 l12">
            <h5 class="breadcrumbs-title "><i class="mdi-social-person"></i>پروفایل کاربر</h5>
                    ...
                    <form action="#">
                        ...
                        <div class="col s12 m6 l3 right">
                            <div class="input-field">
                                ...
                                <input id="mobile" type="text" class="validate" value="09123456789" readonly>
                        ...
                        <div class="col s12 m6 l3 right">
                            <div class="input-field">
                                ...
                                <input id="birth" type="text" class="validate">
                                <label for="birth" class="">تاریخ تولد</label>
                            </div>
                        </div>
                        ...
                        <div class="col s12 m3 l3 margin-upload-btn right margin-top-10">
                            <label for="input-file-max-fs">بارگذاری عکس</label>
